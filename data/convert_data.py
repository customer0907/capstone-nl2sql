...
def main(config):
    ...
    """
    for parent_path, file_name in get_path(root_path, LABEL_FOLDER): # 라벨링데이터
    ...
    append_count = 0
    exist_count = 0
    for parent_path, target_db in get_path(root_path, TABLE_FOLDER): # 원천데이터
    ...
    ### 240426 test ###
    print("# of",  config.name, "exist count -", exist_count)
